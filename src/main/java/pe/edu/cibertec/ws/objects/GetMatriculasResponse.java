 ...
 *       &lt;sequence&gt;
 *         &lt;element name="matriculas" type="{http://www.cibertec.edu.pe/ws/objects}matriculaWs" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class GetMatriculasResponse {
    ...
    protected List<MatriculaWs> matriculas;
     ...
     * 
     */
    public List<MatriculaWs> getMatriculas() {
        if (matriculas == null) {
            matriculas = new ArrayList<MatriculaWs>();
        }
